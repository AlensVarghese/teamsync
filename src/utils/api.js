...
export const addTask = async (newTask) => {
  ...
  try {
    const response = await axios.post(`${API_URL}/tasks`, newTask, getAuthConfig());
...
export const updateTask = async (taskId, updatedTask) => {
  ...
  try {
    const response = await axios.put(`${API_URL}/tasks/${taskId}`, updatedTask, getAuthConfig());
...
export const deleteTask = async (taskId, projectId) => {
  ...
  try {
    await axios.delete(`${API_URL}/tasks/${taskId}/${projectId}`, getAuthConfig());
